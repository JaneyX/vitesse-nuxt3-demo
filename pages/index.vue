  ...
  <div class="w-full">
    ...
    >
      <div class="w-full flex flex-col lg:flex-row items-center justify-center">
        ...
        /> -->
        <!-- 地推宝入口 -->
        <div class="good w-1/3 border-r px-16" data-aos="fade-up">
          <div class="logo w-full">
            <img src="https://www.sc-edu.com/images/dtlogo.png" alt="">
          </div>
          ...
          <div class="more">
            <p>轻松提高地推效率，全面获客，线上手机，高效管理，高度转化，助力机构公众号增粉。</p>
            <BaseButton
              class="max-w-full px-8 py-2 mt-5 bg-inherit text-gradient border border-[#0c66ee] flex items-center justify-center"
            >
              <NuxtLink to="/dtbDetail">
                了解更多
              </NuxtLink>
            </BaseButton>
          </div>
